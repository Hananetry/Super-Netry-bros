...
class Board:
    ...
    def setboard(self,fen):
        ...
        for c in fen:
            if(c=='k'):
                self.cases[i]=Piece('ROI','noir','Rn.png')
                i=i+1
            elif(c=='q'):
                self.cases[i]=Piece('DAME','noir','Dn.png')
                i=i+1
            elif(c=='r'):
                self.cases[i]=Piece('TOUR','noir','Tn.png')
                i=i+1
            elif(c=='n'):
                self.cases[i]=Piece('CAVALIER','noir','Cn.png')
                i=i+1
            elif(c=='b'):
                self.cases[i]=Piece('FOU','noir','Fn.png')
                i=i+1
            elif(c=='p'):
                self.cases[i]=Piece('PION','noir','Pn.png')
                i=i+1
            elif(c=='K'):
               self.cases[i]=Piece('ROI','blanc','Rb.png')
               i=i+1
            elif(c=='Q'):
               self.cases[i]=Piece('DAME','blanc','Db.png')
               i=i+1
            elif(c=='R'):
                self.cases[i]=Piece('TOUR','blanc','Tb.png')
                i=i+1
            elif(c=='N'):
                self.cases[i]=Piece('CAVALIER','blanc','Cb.png')
                i=i+1
            elif(c=='B'):
                self.cases[i]=Piece('FOU','blanc','Fb.png')
                i=i+1
            elif(c=='P'):
                self.cases[i]=Piece('PION','blanc','Pb.png')
                i=i+1
            elif(c=='/'):
                pass
    ...
    def domove(self,depart,arrivee,promote):
        ...
        if(promote!=''):
            if(promote=='q'):
                if self.side2move=="blanc":
                    self.cases[arrivee]=Piece('DAME',self.side2move,"Db.png")
                else:
                    self.cases[arrivee]=Piece('DAME',self.side2move,"Dn.png")
            elif(promote=='r'):
                if self.side2move=="blanc":
                    self.cases[arrivee]=Piece('TOUR',self.side2move,"Tb.png")
                else:
                    self.cases[arrivee]=Piece('TOUR',self.side2move,"Tn.png")
            elif(promote=='n'):
                if self.side2move=="blanc":
                    self.cases[arrivee]=Piece('CAVALIER',self.side2move,"Cb.png")
                else:
                    self.cases[arrivee]=Piece('CAVALIER',self.side2move,"Tn.png")
            elif(promote=='b'):
                if self.side2move=="blanc":
                    self.cases[arrivee]=Piece('FOU',self.side2move,"Fb.png")
                else:
                    self.cases[arrivee]=Piece('FOU',self.side2move,"Fn.png")
        ...
        if(self.cases[pos1].nom=='PION'):
            ...
            if(isEp):
                ...
                if(self.cases[pos1].couleur=='noir'):
                    self.cases[pos2-8]=Piece('PION','blanc',"Pb.png")
                else:
                    self.cases[pos2+8]=Piece('PION','noir',"Pn.png")
        ...
        # Replacing KING -----------------------------------------------
            ...
            if(self.cases[pos1].couleur=='blanc'):
                ...
                if(pos1==60):
                    ...
                    if(pos2==58):
                        self.cases[56]=Piece('TOUR','blanc',"Tb.png")
                        self.cases[59]=Piece()
                    elif(pos2==62):
                        self.cases[63]=Piece('TOUR','blanc',"Tb.png")
                        self.cases[61]=Piece()
            # Black KING
            else:
                if(pos1==4):
                    if(pos2==2):
                        self.cases[0]=Piece('TOUR','noir',"Tn.png")
                        self.cases[3]=Piece()
                    elif(pos2==6):
                        self.cases[7]=Piece('TOUR','noir',"Tn.png")
                        self.cases[5]=Piece()
        # End switch piece----------------------------------------------
