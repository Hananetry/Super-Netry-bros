...
def jouerPartie():
    ...
    Drapeau(mario1,drapeau)
    Drapeau(mario2,drapeau)
...
img0 = PhotoImage(file="decors.png")            # charger la photo "decor6400x288.png"
...
cible2 = c1.create_image(1600,200, anchor=SW, image=photocible)
cible3 = c1.create_image(1755,200, anchor=SW, image=photocible)
cible4 = c1.create_image(2050,200, anchor=SW, image=photocible)
cible5 = c1.create_image(2200,200, anchor=SW, image=photocible)
cible6 = c1.create_image(2400,200, anchor=SW, image=photocible)
cible7 = c1.create_image(2600,200, anchor=SW, image=photocible)
cible8 = c1.create_image(2700,200, anchor=SW, image=photocible)
cible9 = c1.create_image(2755,200, anchor=SW, image=photocible)
...
carapace=c1.create_image(4200, 260, anchor=SW, image=photocarapace)
...
photochateau = PhotoImage(file="chateau.png")
chateau=c1.create_image(8600,163, anchor=CENTER, image=photochateau)
...
photo6 = PhotoImage(file="menu.png")                      # recupere mario
menu = c1.create_image(-100,-133, anchor=NW, image=photo6)    # insertion mario

photo7 = PhotoImage(file="drapeau.png")                      # recupere mario
drapeau = c1.create_image(1000,122, anchor=NW, image=photo7)    # insertion mario
